...
| 2 | **Put the real pricing on pontiac.media and correct the third-party listings.** One pricing page ($100 one-time entry, 20% self-serve margin, 30% managed, no minimum), then update G2 pricing (dated 2022), SourceForge and Slashdot ("$25/month, free version") and Clutch ("$1,000 minimum"). | Perplexity is telling buyers Pontiac costs $25/month; Claude says $99 and a $1,000 minimum; ChatGPT had to read the Terms & Conditions. The correct numbers live on a wiki page no engine has ever cited. | Low | Marketing lead (one afternoon) |
...
**Follow-ups on offer:** a content brief for the "Pontiac vs StackAdapt" and "best self-serve DSPs with no minimum" pages; a recurring monthly run of this baseline; or a one-off deep dive on the wiki template changes.
...
3. The wrong pricing is now in circulation. SourceForge/Slashdot's "$25/month" and Clutch's "$1,000 minimum" are contradicting the wiki's actual "$100 one-time entry fee, 20% margin, no minimum" because the true figures sit on an uncited wiki page and a 2022 G2 pricing entry.
...
- Publish a pricing page on pontiac.media; correct G2, SourceForge, Slashdot and Clutch pricing.
